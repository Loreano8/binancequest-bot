...
# ─── DONNÉES ÉDUCATIVES ───────────────────────────────────────────────────────
QUIZ_BANK = [
    {"q": "What does DeFi stand for?", "q_fr": "Que signifie DeFi ?", "options": ["Digital Finance","Decentralized Finance","Deferred Finance","Defined Finance"], "answer": 1, "explanation": "DeFi = Decentralized Finance. Financial services without banks, on the blockchain.", "explanation_fr": "DeFi = Finance Décentralisée. Des services financiers sans banque, sur la blockchain."},
    {"q": "Who created Bitcoin?", "q_fr": "Qui a créé Bitcoin ?", "options": ["Elon Musk","Vitalik Buterin","Satoshi Nakamoto","CZ"], "answer": 2, "explanation": "Satoshi Nakamoto is the anonymous creator of Bitcoin in 2009.", "explanation_fr": "Satoshi Nakamoto est le pseudonyme du créateur anonyme de Bitcoin en 2009."},
    {"q": "What is Binance's native token?", "q_fr": "Quel est le token natif de Binance ?", "options": ["BTC","ETH","USDT","BNB"], "answer": 3, "explanation": "BNB (Binance Coin) is the official token of the Binance ecosystem.", "explanation_fr": "BNB (Binance Coin) est le token officiel de l'écosystème Binance."},
    {"q": "What does HODL mean in crypto?", "q_fr": "Que veut dire HODL en crypto ?", "options": ["Sell quickly","Hold your crypto long-term","Buy in bulk","Analyze the market"], "answer": 1, "explanation": "HODL comes from a typo of HOLD. Strategy of keeping your crypto without panicking.", "explanation_fr": "HODL vient d'une faute de frappe de HOLD. Stratégie de garder ses cryptos sans paniquer."},
    {"q": "How many Bitcoins will ever exist?", "q_fr": "Combien de Bitcoin existeront au maximum ?", "options": ["10 million","21 million","100 million","Unlimited"], "answer": 1, "explanation": "Bitcoin is limited to 21 million units, making it rare and deflationary.", "explanation_fr": "Bitcoin est limité à 21 millions d'unités, ce qui le rend rare et déflationniste."},
    {"q": "What is a crypto wallet?", "q_fr": "Qu'est-ce qu'un wallet crypto ?", "options": ["An exchange","A digital wallet","A type of blockchain","A token"], "answer": 1, "explanation": "A wallet stores your private keys that give access to your crypto.", "explanation_fr": "Un wallet stocke vos clés privées qui donnent accès à vos cryptos."},
    {"q": "What does RSI measure?", "q_fr": "Que mesure le RSI ?", "options": ["Future price","Network speed","Overbought/oversold conditions","Volume"], "answer": 2, "explanation": "RSI > 70 = overbought, RSI < 30 = oversold. Useful for anticipating reversals.", "explanation_fr": "RSI > 70 = suracheté, RSI < 30 = survendu. Utile pour anticiper des retournements."},
    {"q": "What is staking?", "q_fr": "Qu'est-ce que le staking ?", "options": ["Selling your crypto","Locking crypto to validate the network","Buying NFTs","Trading"], "answer": 1, "explanation": "Staking lets you earn passive rewards by validating a Proof of Stake network.", "explanation_fr": "Le staking permet de gagner des récompenses passives en validant un réseau Proof of Stake."},
    {"q": "When was Binance founded?", "q_fr": "Binance a été fondé en quelle année ?", "options": ["2009","2013","2017","2020"], "answer": 2, "explanation": "Binance was founded in 2017 by Changpeng Zhao (CZ).", "explanation_fr": "Binance a été fondé en 2017 par Changpeng Zhao (CZ)."},
    {"q": "What is an NFT?", "q_fr": "Qu'est-ce qu'un NFT ?", "options": ["A crypto like Bitcoin","A non-fungible token (unique)","A type of wallet","A stablecoin"], "answer": 1, "explanation": "NFT = Non-Fungible Token. A unique digital asset, often used for digital art.", "explanation_fr": "NFT = Non-Fungible Token. Actif numérique unique, souvent utilisé pour l'art digital."},
    {"q": "What is a bull market?", "q_fr": "Que signifie bull market ?", "options": ["Falling market","Rising market","Stable market","Closed market"], "answer": 1, "explanation": "Bull market = rising market. Prices are increasing significantly.", "explanation_fr": "Bull market = marché haussier. Les prix augmentent significativement."},
    {"q": "What is Bitcoin halving?", "q_fr": "C'est quoi le halving Bitcoin ?", "options": ["Split Bitcoin in 2","Halve the miner reward","Double the supply","Close the network"], "answer": 1, "explanation": "Halving cuts miner rewards in half every 4 years, reducing BTC inflation.", "explanation_fr": "Le halving divise par 2 la récompense des mineurs tous les 4 ans, réduisant l'inflation de BTC."},
]
